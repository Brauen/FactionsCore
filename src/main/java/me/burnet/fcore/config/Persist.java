package me.burnet.fcore.config;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import me.burnet.fcore.FactionCore;
import me.burnet.fcore.config.types.EnumTypeAdapter;
import me.burnet.fcore.config.types.LocationTypeAdapter;
...
public class Persist {
    ...
    public File getFile(String name) {
        return new File(FactionCore.getInstance().getDataFolder(), name + ".json");
    }
    ...
    public <T> T loadOrSaveDefault(T def, Class<T> clazz, File file) {
        if (!file.exists()) {
            FactionCore.log("Creating default: " + file);
            this.save(def, file);
            return def;
        }
        ...
        if (loaded == null) {
            FactionCore.log(Level.WARNING, "Using default as I failed to load: " + file);
            ...
            FactionCore.log(Level.WARNING, "Backing up copy of bad me.driftay.score.file to: " + backup);
    ...
    public <T> T load(Class<T> clazz, File file) {
        ...
        try {
            ...
            FactionCore.log(Level.WARNING, ex.getMessage());
        }
