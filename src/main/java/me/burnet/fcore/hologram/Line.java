package me.burnet.fcore.hologram;
...
public class Line {
    ...
    public Line(Hologram hologram, Location location, String text){
        ...
        if (text.equalsIgnoreCase("")){
            armorStand.setCustomName(Util.color("&1"));
        }else{
            armorStand.setCustomName(Util.color(getText()));
        }
    ...
    public void rename(String text){
        setText(text);
        getArmorStand().setCustomName(Util.color(text));
