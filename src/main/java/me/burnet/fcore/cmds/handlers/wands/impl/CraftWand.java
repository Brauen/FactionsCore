package me.burnet.fcore.cmds.handlers.wands.impl;

import itemnbtapi.NBTItem;
import me.burnet.fcore.FactionCore;
import me.burnet.fcore.cmds.handlers.wands.Wand;
import me.burnet.fcore.utils.*;
...
public class CraftWand extends Wand {
    ...
    public void run() {
        Bukkit.getScheduler().runTaskAsynchronously(FactionCore.instance, () -> {
